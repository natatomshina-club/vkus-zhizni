...
> Исправлено 2026-06-06: добавлена проверка `kbju_manual` перед пересчётом. R78 закрыт.
...
| R78 | ✅ закрыт 2026-06-06 — добавлена проверка `kbju_manual` перед пересчётом КБЖУ в `POST /api/tracker/measurements` | — |
