...
function ChannelContent({
  ...
  if (channel.type === 'direct') {
    return <DirectChat memberId={memberId} />
  }
  return null
}
  ...
  function renderMobilePill(ch: Channel) {
    ...
    return (
      <button
        ...
        type="button"
        onClick={() => handleChannelClick(ch.slug, isDirect)}
        className="channel-pill flex items-center gap-1.5 px-3 rounded-full whitespace-nowrap text-xs font-semibold shrink-0"
        style={{
          minHeight: 36,
          fontFamily: 'var(--font-nunito)',
  ...
  return (
    <div className="h-full overflow-hidden">
      ...
      <div className="flex lg:hidden h-full flex-col overflow-hidden">
        ...
        >
          <a href="/dashboard" className="btn-back mr-2 text-lg font-bold" style={{ color: 'var(--text)', textDecoration: 'none' }}>←</a>
          <h1
            className="text-base font-bold"
            style={{ fontFamily: 'var(--font-unbounded)', color: 'var(--text)' }}
          >
