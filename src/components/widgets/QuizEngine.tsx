...
const S = {
  ...
  title: { fontFamily: 'var(--font-unbounded)', fontSize: 17, fontWeight: 700, color: '#3D2B8A', marginBottom: 4, lineHeight: 1.25 },
  ...
  btnBack: { fontFamily: 'var(--font-unbounded)', fontSize: 13, fontWeight: 700, padding: '11px 24px', borderRadius: 100, border: '1.5px solid #EDE8FF', background: '#FAF8FF', color: '#7B6FAA', cursor: 'pointer' },
  btnNext: (disabled: boolean): React.CSSProperties => ({ fontFamily: 'var(--font-unbounded)', fontSize: 13, fontWeight: 700, padding: '11px 24px', borderRadius: 100, border: 'none', background: '#3D2B8A', color: '#fff', cursor: disabled ? 'not-allowed' : 'pointer', opacity: disabled ? 0.4 : 1 }),
  result: { textAlign: 'center' as const, padding: '8px 0' },
  resultEmoji: { fontSize: 52, marginBottom: 12, display: 'block', lineHeight: 1 },
  resultScoreText: { fontFamily: 'var(--font-unbounded)', fontSize: 13, fontWeight: 700, color: '#7B6FAA', textTransform: 'uppercase' as const, letterSpacing: '.08em', marginBottom: 8 },
  ...
  resultTitle: { fontFamily: 'var(--font-unbounded)', fontSize: 20, fontWeight: 700, color: '#3D2B8A', marginBottom: 12, lineHeight: 1.3 },
  ...
  resultCta: { display: 'inline-flex', alignItems: 'center' as const, gap: 8, background: '#4CAF78', color: '#fff', fontFamily: 'var(--font-unbounded)', fontSize: 13, fontWeight: 700, padding: '13px 28px', borderRadius: 100, textDecoration: 'none', boxShadow: '0 4px 16px rgba(76,175,120,.35)' },
